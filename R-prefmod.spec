...
Version  : 0.8.35
Release  : 40
URL      : https://cran.r-project.org/src/contrib/prefmod_0.8-35.tar.gz
Source0  : https://cran.r-project.org/src/contrib/prefmod_0.8-35.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655259057
